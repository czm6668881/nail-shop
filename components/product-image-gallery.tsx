...
const MEASUREMENT_IMAGE = "/images/nail-measurement-guide.png"
  ...
  return (
    <div className="space-y-4">
      <Dialog open={isPreviewOpen} onOpenChange={setIsPreviewOpen}>
        ...
        <DialogContent className="max-w-[96vw] border-0 bg-transparent p-0 shadow-none sm:max-w-[96vw] lg:max-w-[90vw] xl:max-w-[80vw]">
          <div className="relative h-[88vh] w-full overflow-hidden rounded-lg">
            <Image
              src={selectedImage}
              alt={isMeasurementImage ? "Nail measurement tutorial full view" : `${name} large image`}
              fill
              className={isMeasurementImage ? "object-contain bg-white" : "object-contain"}
              sizes="100vw"
              priority
            />
          </div>
