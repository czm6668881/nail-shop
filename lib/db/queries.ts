...
export const updateOrderTrackingNumber = wrap("updateOrderTrackingNumber")
export const deleteOrder = wrap("deleteOrder")
export const deleteAllOrders = wrap("deleteAllOrders")
...
export const getSiteSetting = wrap("getSiteSetting")
export const upsertSiteSetting = wrap("upsertSiteSetting")
export const deleteSiteSetting = wrap("deleteSiteSetting")
